---
description: Autonomous browser testing using Playwright based on stories and plans
---
...
-- Base URL (assume app is running locally): `http://localhost:6001`
-- Key routes:
  - Home: `/`
...
3. **Example: Story 1 – Browse Movie Catalog**
   ...
   - Criterion: "Movie catalog is accessible from the main navigation."
    1. Call mcp_microsoft_pla_browser_navigate to open `http://localhost:6001/`.
