...
@if($dueRecurring)
<a href="{{ route('recurring.index') }}"  class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800/60 text-amber-700 dark:text-amber-400 text-xs font-semibold hover:bg-amber-100 transition-colors">
...
<a href="{{ route('dashboard') }}"  class="p-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white shadow-sm text-xs" title="Refresh data">
...
<a href="{{ route('reports.index') }}"  class="font-semibold text-indigo-600 dark:text-indigo-400 hover:underline">Lihat Laporan →</a>
</div>
</div>
...
<a href="{{ route('saving-goals.index') }}"  class="inline-block mt-1.5 text-xs font-bold text-emerald-700 dark:text-emerald-300 hover:text-emerald-900 bg-white dark:bg-slate-900 px-3 py-1.5 rounded-xl border border-emerald-200 dark:border-emerald-800 shadow-sm">
Kelola Tabungan
</a>
</div>
</div>
...
<a href="{{ route('saving-goals.index') }}"  class="inline-block text-xs font-bold text-emerald-700 dark:text-emerald-300 bg-white dark:bg-slate-900 px-3.5 py-1.5 rounded-xl border border-emerald-200 dark:border-emerald-800 shadow-sm">
Buat Target →
</a>
</div>
</div>
...
<a href="{{ route('accounts.index') }}"  class="text-xs font-semibold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1">
...
@empty
    <div class="col-span-full py-8 text-center text-slate-500 dark:text-slate-400 text-sm">Belum ada dompet/rekening. <a href="{{ route('accounts.index') }}"  class="text-indigo-600 dark:text-indigo-400 font-bold underline ml-1">Tambah Dompet</a></div>
@endforelse
</div>
</section>
...
<a class="font-semibold text-indigo-600 dark:text-indigo-400 group-hover:translate-x-0.5 transition-transform flex items-center gap-0.5" href="{{ route('reports.index') }}" >
Audit Laporan →
</a>
</div>
</div>
...
@if($activeBudget)
    ...
    <div class="bg-gradient-to-b from-rose-50/50 dark:from-rose-950/30 to-white dark:to-slate-900 rounded-2xl p-5 sm:p-6 border border-rose-200/70 dark:border-rose-800/50 shadow-soft flex flex-col justify-between h-full hover:border-rose-300 transition-all">
        ...
        <div class="mt-4 pt-3 border-t border-rose-100/60 dark:border-rose-800/60 flex items-center justify-between text-xs">
            ...
            <a href="{{ route('budgets.index') }}"  class="font-semibold text-slate-800 dark:text-slate-200 hover:text-slate-900 dark:text-white bg-white dark:bg-slate-800 px-2.5 py-1 rounded-lg border border-slate-200 dark:border-slate-700 shadow-xs">
                Kelola Anggaran
            </a>
        </div>
    </div>
@else
    <div class="bg-gradient-to-b from-indigo-50/50 dark:from-indigo-950/30 to-white dark:to-slate-900 rounded-2xl p-5 sm:p-6 border border-indigo-200/70 dark:border-indigo-800/50 shadow-soft flex flex-col justify-between h-full hover:border-indigo-300 transition-all">
        ...
        <div class="mt-4 pt-3 border-t border-indigo-100/60 dark:border-indigo-800/60 flex items-center justify-between text-xs">
            ...
            <a href="{{ route('budgets.index') }}"  class="font-semibold text-white bg-indigo-600 hover:bg-indigo-700 px-2.5 py-1 rounded-lg shadow-xs">
                Buat Anggaran →
            </a>
        </div>
    </div>
...
@if($activeGoal)
    ...
    <div class="bg-gradient-to-b from-emerald-50/50 dark:from-emerald-950/30 to-white dark:to-slate-900 rounded-2xl p-5 sm:p-6 border border-emerald-200/70 dark:border-emerald-800/50 shadow-soft flex flex-col justify-between h-full hover:border-emerald-300 transition-all">
        ...
        <div class="mt-4 pt-3 border-t border-emerald-100/60 dark:border-emerald-800/60 flex items-center justify-between text-xs">
            ...
            <a href="{{ route('saving-goals.index') }}"  class="font-semibold text-emerald-700 dark:text-emerald-300 hover:underline">
                Setor / Detail →
            </a>
        </div>
    </div>
...
<a href="{{ route('transactions.index') }}"  class="px-4 py-2 rounded-full bg-slate-900 dark:bg-indigo-600 hover:bg-slate-800 dark:hover:bg-indigo-500 text-white font-semibold text-xs transition-all shadow-sm flex items-center gap-1.5 self-start sm:self-auto">
...
<a class="inline-flex items-center gap-1.5 text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:underline py-1 px-3" href="{{ route('transactions.index') }}" >
